...
CurrencyController.prototype.index = function(req, res) {
  ...
  var rateSourceKeys = Object.keys(self.rateSources);
  for (var k = 0; k < rateSourceKeys.length; k++) {

    var key = rateSourceKeys[k];
    if (self.rates[key] === undefined || currentTime >= (self.timestamp + self.currencyDelay)) {
